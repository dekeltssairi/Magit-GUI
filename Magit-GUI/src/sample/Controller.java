...
//            URL url = getClass().getResource("../InitializeRepository/InitializeRepository.fxml");
//            fxmlLoader.setLocation(url);
//            Parent root =  fxmlLoader.load(url.openStream());

            Parent root = fxmlLoader.load(getClass().getResource("C:\\Users\\noywo\\java\\Magit-GUI\\Magit-GUI\\src\\sample\\InitializeRepository\\InitializeRepository.fxml"));
